...
define mcom03_sbl_extract_certs
	mkdir -p $(@D)/certs; \
	mkdir -p $(@D)/certs/$(2); \
	$(TAR) xf $(1) -C $(@D)/certs/$(2)
endef

ifneq ($(MCOM03_SBL_SBIMG_SEC_TYPE),none)
MCOM03_SBL_SBIMG_ROOT_CA = $(@D)/certs/sbimg/rootCA.der
MCOM03_SBL_SBIMG_NON_ROOT_CA = $(@D)/certs/sbimg/nonRootCA.der
MCOM03_SBL_SBIMG_FW_CA = $(@D)/certs/sbimg/fwCA.der
MCOM03_SBL_SBIMG_FW_PK = $(@D)/certs/sbimg/fwPrivateKey.der

MCOM03_SBL_FIT_KEYS = $(@D)/certs/fit
MCOM03_SBL_FIT_KEY_NAME = $(call qstrip,$(BR2_PACKAGE_MCOM03_SBL_FIT_KEY_NAME))
MCOM03_SBL_FIT_SIGN_ALGO = $(call qstrip,$(BR2_PACKAGE_MCOM03_SBL_FIT_SIGN_ALGO))

define MCOM03_SBL_EXTRACT_SBIMG_CERTS
	$(call mcom03_sbl_extract_certs,$(BR2_PACKAGE_MCOM03_SBL_SBIMG_CERTS_TAR),sbimg)
endef

define MCOM03_SBL_EXTRACT_FIT_CERTS
	$(call mcom03_sbl_extract_certs,$(BR2_PACKAGE_MCOM03_SBL_FIT_CERTS_TAR),fit)
endef

MCOM03_SBL_POST_EXTRACT_HOOKS += MCOM03_SBL_EXTRACT_SBIMG_CERTS MCOM03_SBL_EXTRACT_FIT_CERTS
MCOM03_SBL_POST_RSYNC_HOOKS += MCOM03_SBL_EXTRACT_SBIMG_CERTS MCOM03_SBL_EXTRACT_FIT_CERTS
endif
...
MCOM03_SBL_CONF_OPTS += \
	...
	-DFIT_KEYS=$(MCOM03_SBL_FIT_KEYS) \
	-DFIT_KEY_NAME=$(MCOM03_SBL_FIT_KEY_NAME) \
	-DFIT_SIGN_ALGO=$(MCOM03_SBL_FIT_SIGN_ALGO)
...
MCOM03_SBL_INSTALL_TARGET_CMDS = \
	$(MCOM03_SBL_MAKE_ENV) $(MCOM03_SBL_BUILD_ENV) DESTDIR=$(BINARIES_DIR) \
		$(BR2_CMAKE) --install $(MCOM03_SBL_BUILDDIR)
