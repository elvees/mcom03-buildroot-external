...
ifeq ($(BR2_PACKAGE_POWERVR_ROGUE_LIBS_PDUMP),y)
POWERVR_ROGUE_LIBS_SETTINGS += PDUMP=1
else
POWERVR_ROGUE_LIBS_SETTINGS += PDUMP=0
endif
...
define DOWNLOAD_3RDPARTY
	$(POWERVR_ROGUE_LIBS_PKGDIR)download-llvm.sh $(POWERVR_ROGUE_LIBS_LLVM_DIR)
	$(POWERVR_ROGUE_LIBS_PKGDIR)download-nvme.sh $(POWERVR_ROGUE_LIBS_NNVM_DIR)
endef

POWERVR_ROGUE_LIBS_POST_DOWNLOAD_HOOKS += DOWNLOAD_3RDPARTY
