...
MCOM03_ROGUE_MODULES_INSTALL_IMAGES = YES
...
MCOM03_ROGUE_MODULES_TARGET_FILES_DIR=$(@D)/binaries
...
define MCOM03_ROGUE_MODULES_INSTALL_IMAGES_CMDS
	# Create directory for binaries
	rm -rf $(MCOM03_ROGUE_MODULES_TARGET_FILES_DIR)
	mkdir -p $(MCOM03_ROGUE_MODULES_TARGET_FILES_DIR)

	$(MAKE) -C $(@D) $(MCOM03_ROGUE_MODULES_SETTINGS) \
		DISCIMAGE=$(MCOM03_ROGUE_MODULES_TARGET_FILES_DIR) SKIP_MODULEDIR_CHECK=1 install

	tar -C $(MCOM03_ROGUE_MODULES_TARGET_FILES_DIR) -czf $(BINARIES_DIR)/mcom03-rogue-modules-$\
		$(MCOM03_ROGUE_MODULES_VERSION)-$(shell date --iso).tar.gz .
endef
