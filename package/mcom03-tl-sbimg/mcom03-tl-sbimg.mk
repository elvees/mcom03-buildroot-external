...
MCOM03_TL_SBIMG_SEC_TYPE = $(call qstrip,$(BR2_PACKAGE_MCOM03_TL_SBIMG_SEC_TYPE))
...
ifneq ($(MCOM03_TL_SBIMG_SEC_TYPE),none)
...
define MCOM03_TL_SBIMG_EXTRACT_CERTS
	mkdir -p $(@D)/certs
	$(TAR) xf $(BR2_PACKAGE_MCOM03_TL_SBIMG_CERTS_TAR) -C $(@D)/certs
endef
...
MCOM03_TL_SBIMG_MAKE_OPTS += \
	...
	MCOM03_TL_SBIMG_BINARIES_DIR=$(BINARIES_DIR) \
	MCOM03_TL_SBIMG_SEC_TYPE=$(MCOM03_TL_SBIMG_SEC_TYPE) \
	MCOM03_TL_SBIMG_IMG_ALIGN=$(BR2_PACKAGE_MCOM03_TL_SBIMG_IMG_ALIGN) \
