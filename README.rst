=======================================
Внешнее дерево Buildroot для MCom-03(R)
=======================================

`Внешнее дерево Buildroot`__ содержит поддержку для MCom-03, MCom-03R.
...
MCom-03 Buildroot содержит файлы фрагментов:
...
MCom-03R Buildroot содержит файлы фрагментов:

* ``linux618.fragment`` - поддержка сборки с ядром 6.18.
